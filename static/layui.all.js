    ...
    b.prototype.config = {
        ...
        layui.each(r, function (a, r) {
            var l = r.children && r.children.length > 0,
                ...
                }(), "<div class=\"layui-tree-right\">" + (t.isright ? '<span class=\"category_preview\">预览</span> | <span class=\"category_document\">文档</span> | <span class=\"category_subclass\">增加子类</span> | <span class=\"category_change\">更改</span> | <span class=\"category_delete\">删除</span>' : '') + "</div></div></div>"].join(""));
    ...
    F.prototype.config = {
        ...
        "object" == typeof a.defaultToolbar && layui.each(a.defaultToolbar, function (e, t) {
            ...
            if (i.content == undefined) {
                ...
                i && d.push('<div class="layui-inline" style="height:auto;width:auto;padding:inherit;border:aliceblue;margin-left:10px;">' + i.content + '</div>')
            }
...
function TopRightToolbar() {
    $("#top-right-model").html($("#TopRightToolbar").html());
}
